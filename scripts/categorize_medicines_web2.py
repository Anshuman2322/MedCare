"""
Categorize medicine folders inside final_web_2 directory.

Features:
- Scans immediate subfolders of final_web_2/final_web_2
...
- Optional: --base-dir to change the base directory (default: ./final_web_2/final_web_2)

Usage (PowerShell on Windows):
  # Dry run (no changes)
  python .\scripts\categorize_medicines_web2.py --dry-run --base-dir "s:\MedCare\final_web_2\final_web_2"

  # Real run (will move folders)
  python .\scripts\categorize_medicines_web2.py --base-dir "s:\MedCare\final_web_2\final_web_2"
"""
...
# Updated category keywords based on final_web_2 contents
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Categorize medicine folders inside final_web_2.")
    parser.add_argument("--base-dir", default=os.path.join(os.getcwd(), "final_web_2", "final_web_2"), help="Path to final_web_2/final_web_2 base directory")
