...
CATEGORY_KEYWORDS: List[Tuple[str, List[str]]] = [
    (
        ...
        [
            ...
            "duratia",
            "super-tadarise",
            "tadarise",  # catch "super tadarise"
            "malegra",
            "p-force",   # catch "extra-super-p-force"
            "dapoforce",
        ],
    ),
    ("Pain_Killer", ["flu-dac", "dulata", "amitocare"]),
    ("Anti_Biotic", ["amoxicillin", "cefadroxil", "cefixime", "azithromycin"]),
    (
    ...
    ("Anti_Cancer", ["abi", "alinta", "capegard", "rolimus", "arimidex", "iressa"]),
    ("Anti_Viral", ["hepcinat", "mydekla", "my-dekla", "ledipasvir", "abirforce"]),
    ("Anti_Malarial", ["artemether", "artesunate", "coartem", "apleleeva"]),
    ("Injections", ["injection", "ampoule"]),
    (
        "Skin_Allergy_Asthma",
        ["cetirizine", "astafen", "alergat", "montelukast", "fexofenadine", "anti-allergic"],
    ),
    ("Supplements_Vitamins_Hair", ["adgain", "throw-plus", "vitamin", "hair"]),
    ("Chronic_Cardiac", ["finast", "capsule", "blood", "bp"]),
]
